...
PROPERTY_SOURCE(Aplan::AplanConstraintGroup, App::DocumentObjectGroup)

AplanConstraintGroup::AplanConstraintGroup()
{
}
...
{
    /// @cond DOXERR
    PROPERTY_SOURCE_TEMPLATE(Aplan::AplanConstraintGroupPython, Aplan::AplanConstraintGroup)
    template <>
    ...
    template class AplanAppExport FeaturePythonT<Aplan::AplanConstraintGroup>;
