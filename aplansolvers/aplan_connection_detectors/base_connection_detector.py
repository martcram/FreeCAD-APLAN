...
__title__ = "Abstract base classes of the FreeCAD APLAN ConnectionDetector object"
...
class IConnectionDetector(metaclass=abc.ABCMeta):
    BaseType = "Aplan::ConnectionDetectorPython"
...
class IVPConnectionDetector(metaclass=abc.ABCMeta):
    """ViewProvider of the ConnectionDetector object."""
