...
#ifndef APLAN_VIEWPROVIDERANALYSIS_HPP
#define APLAN_VIEWPROVIDERANALYSIS_HPP
...
namespace AplanGui
{
    class AplanGuiExport ViewProviderAplanAnalysis : public Gui::ViewProviderDocumentObjectGroup
    {
        Q_DECLARE_TR_FUNCTIONS(AplanGui::ViewProviderAplanAnalysis)
        PROPERTY_HEADER(AplanGui::ViewProviderAnalysis);

    public:
        /// constructor.
        ViewProviderAplanAnalysis();

        /// destructor.
        virtual ~ViewProviderAplanAnalysis();
    ...
    typedef Gui::ViewProviderPythonFeatureT<ViewProviderAplanAnalysis> ViewProviderAplanAnalysisPython;
} // namespace AplanGui

#endif // APLAN_VIEWPROVIDERANALYSIS_HPP
